---
description: '该内容涵盖核心操作、权限管理、代码与数据库检查工具、运维工具及PHP API文档生成。提供缓存定义与持久化示例（包括insert和update），支持将数据持久化到数据库。需下载运行后配置apidoc、op_mail和RBAC。'
lastUpdated: '2026-06-21 16:51:47'
head:
  - - meta
    - name: 'og:title'
      content: 'Core / 核心'
  ...
  - - meta
    - name: 'og:description'
      content: '该内容涵盖核心操作、权限管理、代码与数据库检查工具、运维工具及PHP API文档生成。提供缓存定义与持久化示例（包括insert和update），支持将数据持久化到数据库。需下载运行后配置apidoc、op_mail和RBAC。'
  - - meta
    - name: 'og:url'
