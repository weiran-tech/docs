---
description: 'Webhook是一种回调机制，需在支持HTTP/HTTPS的环境下安装配置。通过示例可快速集成，支持多种消息类型（如文本、图片、事件通知等），实现实时数据推送与系统联动。'
lastUpdated: '2026-06-21 16:51:27'
head:
  - - meta
    - name: 'og:title'
      content: 'webhook'
  ...
  - - meta
    - name: 'og:description'
      content: 'Webhook是一种回调机制，需在支持HTTP/HTTPS的环境下安装配置。通过示例可快速集成，支持多种消息类型（如文本、图片、事件通知等），实现实时数据推送与系统联动。'
  - - meta
    - name: 'og:url'
      content: 'https://weiran.tech//wr-1.x/extension/webhook.html'
  - - meta
    - name: 'og:image'
