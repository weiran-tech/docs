---
description: 'Poppy模块系统提供模块生命周期管理（创建、启用/禁用、优化）、数据表管理、文件生成器、事件、数据库Seeder与Factory、模型处理、Helpers、Blade语法、验证、文件树及模块配置等功能，构成完整的模块化开发工具链。'
lastUpdated: '2026-06-22 14:29:45'
head:
  - - meta
    - name: 'og:title'
      content: 'README'
  ...
  - - meta
    - name: 'og:description'
      content: 'Poppy模块系统提供模块生命周期管理（创建、启用/禁用、优化）、数据表管理、文件生成器、事件、数据库Seeder与Factory、模型处理、Helpers、Blade语法、验证、文件树及模块配置等功能，构成完整的模块化开发工具链。'
  - - meta
    - name: 'og:url'
      content: 'https://weiran.tech//4.x/readme.html'
---
# README
