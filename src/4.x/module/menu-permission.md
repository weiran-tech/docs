---
description: '权限和菜单功能包括定义、初始化、设定，支持多种菜单类型和键说明，可在控制器中通过操作验证进行权限使用。'
lastUpdated: '2026-06-22 14:44:05'
head:
  - - meta
    - name: 'og:title'
      content: '权限和菜单'
  ...
  - - meta
    - name: 'og:description'
      content: '权限和菜单功能包括定义、初始化、设定，支持多种菜单类型和键说明，可在控制器中通过操作验证进行权限使用。'
  - - meta
    - name: 'og:url'
      content: 'https://weiran.tech//4.x/module/menu-permission.html'
---
# 权限和菜单
