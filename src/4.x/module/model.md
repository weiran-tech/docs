---
description: '文档总结了模型命名、放置位置、表名与主键指定（id可省略）、插入字段、时间自动维护（默认true，可指定logined_at等特殊时间字段）、注释命名、枚举使用、关联关系命名、调用注释友好提示、数据表设计范式、常用字段、索引命名（index/unique）以及Poppy框架中快速排序查询数据的要点。'
lastUpdated: '2026-06-22 14:44:13'
head:
  - - meta
    - name: 'og:title'
      content: '模型'
  ...
  - - meta
    - name: 'og:description'
      content: '文档总结了模型命名、放置位置、表名与主键指定（id可省略）、插入字段、时间自动维护（默认true，可指定logined_at等特殊时间字段）、注释命名、枚举使用、关联关系命名、调用注释友好提示、数据表设计范式、常用字段、索引命名（index/unique）以及Poppy框架中快速排序查询数据的要点。'
  - - meta
    - name: 'og:url'
