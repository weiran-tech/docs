---
description: '本文档说明模块开发流程，包括文件树结构、服务注册、验证、设置、模块约定及缓存处理，旨在规范功能实现与代码组织。'
lastUpdated: '2026-06-22 14:08:42'
head:
  - - meta
    - name: 'og:title'
      content: '说明'
  ...
  - - meta
    - name: 'og:description'
      content: '本文档说明模块开发流程，包括文件树结构、服务注册、验证、设置、模块约定及缓存处理，旨在规范功能实现与代码组织。'
  - - meta
    - name: 'og:url'
