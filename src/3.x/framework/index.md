---
description: '该框架提供模块管理功能，包括启用/禁用、创建模块及优化；支持代码生成器，可生成控制器、模型、中间件、策略、服务提供者、请求、测试、事件等文件；数据库管理包含Seeder和Factory生成；还涵盖事件监听、Blade语法、验证及文件树等特性。'
lastUpdated: '2026-06-29 22:53:12'
head:
  - - meta
    - name: 'og:title'
      content: '框架'
  ...
  - - meta
    - name: 'og:description'
      content: '该框架提供模块管理功能，包括启用/禁用、创建模块及优化；支持代码生成器，可生成控制器、模型、中间件、策略、服务提供者、请求、测试、事件等文件；数据库管理包含Seeder和Factory生成；还涵盖事件监听、Blade语法、验证及文件树等特性。'
  - - meta
    - name: 'og:url'
      content: 'https://weiran.tech/3.x/framework/index.html'
---
# 框架
