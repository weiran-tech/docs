---
description: '服务器环境配置需安装Nginx或Apache，开启重写与虚拟主机，允许访问index.php及.htaccess。Laravel运行需配置计划任务、Supervisor队列监听与自动化部署。开发中注意错误查找，生成API文档（apidoc）、PHP文档（phpdoc）及global.js文件时须使用PHP 5.5.9以上版本。'
lastUpdated: '2026-06-22 13:43:02'
head:
  - - meta
    - name: 'og:title'
      content: '服务器环境配置'
  ...
  - - meta
    - name: 'og:description'
      content: '服务器环境配置需安装Nginx或Apache，开启重写与虚拟主机，允许访问index.php及.htaccess。Laravel运行需配置计划任务、Supervisor队列监听与自动化部署。开发中注意错误查找，生成API文档（apidoc）、PHP文档（phpdoc）及global.js文件时须使用PHP 5.5.9以上版本。'
  - - meta
    - name: 'og:url'
      content: 'https://weiran.tech//2.x/op.html'
  - - meta
    - name: 'og:image'
      content: 'https://file.wulicode.com/feishu-images/f4b02c130d8cda221bfbf063bc9b23f7.jpg'
---
# 服务器环境配置
...
![](https://file.wulicode.com/feishu-images/f4b02c130d8cda221bfbf063bc9b23f7.jpg)
