---
description: '根据内容，总结数据库设计规范：包括模型命名与放置位置、映射表与主键、注释原则、KV定义、Enum使用、关联关系命名、数据表字段和索引命名、唯一验证、表创建、like与普通搜索、排序以及建表规范。'
lastUpdated: '2026-06-22 13:41:40'
head:
  - - meta
    - name: 'og:title'
      content: '模型'
  ...
  - - meta
    - name: 'og:description'
      content: '根据内容，总结数据库设计规范：包括模型命名与放置位置、映射表与主键、注释原则、KV定义、Enum使用、关联关系命名、数据表字段和索引命名、唯一验证、表创建、like与普通搜索、排序以及建表规范。'
  - - meta
    - name: 'og:url'
