---
description: 'API文档初始化说明：将所有参数按字母排序并拼接成Kv字符串，再进行sha1(md5($str))加密。涵盖请求规范、代码返回规范、文档生成测试工具、路由写法、返回值及版本说明。'
lastUpdated: '2026-06-22 13:42:13'
head:
  - - meta
    - name: 'og:title'
      content: 'Api文档 1.0'
  ...
  - - meta
    - name: 'og:description'
      content: 'API文档初始化说明：将所有参数按字母排序并拼接成Kv字符串，再进行sha1(md5($str))加密。涵盖请求规范、代码返回规范、文档生成测试工具、路由写法、返回值及版本说明。'
  - - meta
    - name: 'og:url'
      content: 'https://weiran.tech//2.x/api.html'
  - - meta
    - name: 'og:image'
      content: 'https://file.wulicode.com/feishu-images/9ee5bb95acd9431baab229b520969841.png'
---
# Api文档 1.0
...
![](https://file.wulicode.com/feishu-images/9ee5bb95acd9431baab229b520969841.png)
...
![](https://file.wulicode.com/feishu-images/5fd3db50f20c586d975d5784e648b1fc.png)
...
![](https://file.wulicode.com/feishu-images/e896000567b2ea9922593964b067767e.png)
